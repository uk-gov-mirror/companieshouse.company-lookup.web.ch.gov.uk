...
public class CompanyDetailController {
    ...
    @GetMapping
    public String getCompanyDetail(@RequestParam("forward") String forward,
        @ModelAttribute("companyDetail") @Valid CompanyDetail companyDetail, Model model)
        ...
        UriComponentsBuilder uriComponentsBuilder = UriComponentsBuilder
            .fromUriString("/company-lookup/search")
            .queryParam("forward", forward);

        model.addAttribute("backButton", uriComponentsBuilder.build().toUri());
